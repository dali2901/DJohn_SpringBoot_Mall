...
public class ProductDaoImpl implements ProductDao {
    ...
    public ProductDaoImpl(NamedParameterJdbcTemplate testIfMatchJdbcTemplate) {
    ...
    public Integer countProduct(ProductQueryParams productQueryParams) {
        ...
        Integer total = testIfMatchJdbcTemplate.queryForObject(sql, map, Integer.class);
    ...
    public List<Product> getProducts(ProductQueryParams productQueryParams) {
        ...
        List<Product> productList = testIfMatchJdbcTemplate.query(sql, map, new ProductRowMapper());
